...
function formValidation ( ){
    flag = true;
if(x != isArabic){
    alert("ادخل الاسم باللغة العربية");
 flag=false;
}
...
if (uid.length != 14 || !isNumber(uid)) {
  alert("ادخل الرقم القومى الصحيح");
           flag = false;
}*/
      ...
      <div class="container" style=" margin-right: 0px" >
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active"><a href="home.html" class="nav-link">الرئسية</a></li>
            <li class="nav-item"><a href="about.html" class="nav-link" >عيادات</a></li>
            <li class="nav-item"><a href="medicine.html" class="nav-link">ادوية و عقاقير</a></li>
            <li class="nav-item"><a href="consult.html" class="nav-link">مستشارك الطبى</a></li>
            <li class="nav-item"><a href="19.html" class="nav-link">كوفيد 19</a></li>
              <li class="nav-item"><a href="tt3emat.html" class="nav-link">تطعيمات </a></li>
...
<div class="containersi">
    ...
    <form class="form" id="createAccount" name="myform" onsubmit="return formValidation();" method="post" >
                <h1 class="form__title">انشاء حساب</h1>

              <div class="form__input-group">

                    <input type="text" name="name" class="form__input" autofocus placeholder="الاسم الرباعى" required>

                </div>
                <div class="form__input-group">
                    <input type="text" class="form__input" name="idnum" autofocus placeholder="رقم البطاقة القومية" required>

                </div>
                <div class="form__input-group">
                    <input type="text" class="form__input" name="age" autofocus placeholder="السن" required>

                </div>
                <div class="form__input-group">

                    <li><select name="city" id="city" type="text" class="form__input" autofocus placeholder="المدينة" required>

                    <option value="القاهرة">القاهرة</option>
                    <option value="الجيزة">الجيزة</option>
                    <option value="الاسكندرية">الاسكندرية</option>
                    <option value="الشيخ">كفر الشيخ</option>
                    <option value="الدلتامدن">مدن الدلتا</option>
                ...
                <div class="form__input-group">
                    <input type="text" class="form__input" name="area" autofocus placeholder="المنطقة" required>

                </div>
                <div class="form__input-group">
                    <!--<input type="text" class="form__input" autofocus placeholder="الجنس" required>-->
                    <li><select name="gender" type="text" class="form__input" autofocus placeholder="الجنس" required>
...
<option value="انثى">انثى</option>
                ...
                <div class="form__input-group">
                    <input type="text" class="form__input" name="history" autofocus placeholder="التاريخ المرضى" required>
                    <div class="form__input-error-message"></div>
                </div>
                <div class="form__input-group">
                    <input type="text" class="form__input" name="email" autofocus placeholder="عنوان البريد الالكترونى" required>
                    <div class="form__input-error-message"></div>
                </div>
                <div class="form__input-group">
                    <input type="text" class="form__input" name="username" autofocus placeholder="اسم المستخدم">
                    <div class="form__input-error-message"></div>
                </div>
                <div class="form__input-group">
                    <input type="password" class="form__input"name="pass" autofocus placeholder="كلمة السر">
                    <div class="form__input-error-message"></div>
                </div>
                <button class="form__button" type="submit" onclick="signup.php">المتابعة</button>
                <p class="form__text">
                    <a class="form__link" href="login.php" id="linkLogin">بالفعل لديك حساب ؟ تسجيل الدخول</a>
                </p>
            </form>
            </div>
            <br>
...
<div class="container">
   ...
   <div class="col-md-6 col-lg">
    ...
    <h2 class="logo"><a href="#">وزارة الصحة و السكان</a></h2>
   <b>  <p style="font-size:16px ">يمكنك التواصل معانا عن طريق السوشيال ميديا :</p></b>
...
<h2 class="ftco-heading-2">الخدمات</h2>
  <ul class="list-unstyled" style="margin-left:10px ; padding:0px">
 <li style="margin-right:5px "><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3 " >عيادات  </span></a></li>
<li style="margin-right:5px "><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3"> ادوية و عقاقير</span></a></li>
<li style="margin-right:5px "><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3"> مستشارك الطبى</span></a></li>
<li style="margin-right:5px "><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3">كوفيد 19</span></a></li>
<li style="margin-right:5px "><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3">التطعيمات</span></a></li>
<li style="margin-right:5px "><a href="#" class="py-1 d-block"><span class="fa fa-check mr-3"> للتواصل معانا</span></a></li>
    </ul>
     </div>
         </div>
...
<div class="col-md-6 col-lg">
  <div class="ftco-footer-widget bg-primary p-4 py-5">
       <h2 class="ftco-heading-2">ساعات العمل</h2>
        <div class="opening-hours">
        <h4>خلال اليوم:</h4>
          <p class="pl-3">
          	<span> السبت - الخميس: 8ص ل 12م</span>
          	<span>الجمعة: 10ص ل 10م</span>
            </p>
            <h4>الاجازات:</h4>
            	<p class="pl-3">
        	<span>الاجازات الرسمية فقط</span>
